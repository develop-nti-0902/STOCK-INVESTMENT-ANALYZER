...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("idx_account_transactions_symbol", table_name="account_transactions")
    op.drop_index(
        "idx_account_transactions_executed_at",
        table_name="account_transactions",
    )
    op.drop_index("idx_account_transactions_account", table_name="account_transactions")
    op.drop_table("account_transactions")
    op.drop_index("idx_account_portfolios_symbol", table_name="account_portfolios")
    op.drop_index("idx_account_portfolios_account", table_name="account_portfolios")
