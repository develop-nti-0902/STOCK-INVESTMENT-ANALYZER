...
- [マイルストーン一覧](#マイルストーン一覧)
  ...
  - [3. マイルストーン詳細](#3-マイルストーン詳細)
    ...
    - [v0.4.0 - 基本UI・ダッシュボード](#v040---基本uiダッシュボード)
...
gantt
    ...
    v0.4.0 基本UI・ダッシュボード    :v04, after v03, 2w

    section Phase 3: 基本機能
    v0.5.0 銘柄検索・詳細表示       :v05, after v04, 2w
...
| **Phase 2: データ収集** | v0.3.0 - v0.4.0 | 4週間 | 株価データ収集、基本UI     |
...
| v0.4.0 UI/ダッシュボード | プレゼンテーション / API                     | サービス(集計) / データアクセス                   | WebSocket基盤確立                |
...
graph LR
    ...
    v03 --> v04[v0.4.0<br/>UI/ダッシュボード]
    v04 --> v05[v0.5.0<br/>銘柄検索]
