...
def test_jobstatus_enum_values():
    """JobStatus Enum のメンバが正しく列挙されることを確認."""
...
def test_batch_job_params_allows_extra():
    """BatchJobParams が追加フィールドを許容することを確認."""
...
def test_batch_execution_create_minimal():
    """最小限のフィールドで BatchExecutionCreate が作成できることを確認."""
