...
class Industry09PetroleumCoalStrategy(BaseScreeningStrategy):
    """業種09: 石油・石炭製品 (Petroleum and Coal Products)のスクリーニング戦略。
    ...
    def get_default_config() -> ScreeningConfig:
        ...
        業種: 石油・石炭製品 (Petroleum and Coal Products)
