...
class Industry01AquacultureForestryStrategy(BaseScreeningStrategy):
    """業種01: 水産・農林業 (Aquaculture, Agriculture, Forestry)のスクリーニング戦略。
    ...
    def get_default_config() -> ScreeningConfig:
        ...
        業種: 水産・農林業 (Aquaculture, Agriculture, Forestry)
