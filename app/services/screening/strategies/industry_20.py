...
class Industry20UtilitiesStrategy(BaseScreeningStrategy):
    """業種20: 電気・ガス業 (Electric Utilities and Gas)のスクリーニング戦略。
    ...
    def get_default_config() -> ScreeningConfig:
        ...
        業種: 電気・ガス業 (Electric Utilities and Gas)
