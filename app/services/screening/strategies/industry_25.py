...
class Industry25ITCommunicationStrategy(BaseScreeningStrategy):
    """業種25: 情報・通信業 (Information and Communications)のスクリーニング戦略。
    ...
    def get_default_config() -> ScreeningConfig:
        ...
        業種: 情報・通信業 (Information and Communications)
